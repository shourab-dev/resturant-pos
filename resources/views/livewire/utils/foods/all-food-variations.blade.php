<div class="mt-25">
    <div class="row">
        ...
        <div wire:key="{{ $foodVariation->id }}"  class="col-lg-4 mb-3" style="min-height: {{ $foodVariation->icon ? "auto" : '200px' }}">
            <div class="card h-100">
                ...
                <div class="card-body {{ $foodVariation->icon ? "row" : '' }}">
                    ...
                    <div class="col-3">
                        <img style="max-width: 80px;" src="{{ asset('storage/'.$foodVariation->icon ) }}" alt="" class="rounded">
                    </div>
                    @endif
